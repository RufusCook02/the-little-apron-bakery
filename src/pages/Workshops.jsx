    ...
    <div className="la-page">
      ...
      >
        ...
        >
          ...
          >
            "I didn't have these opportunities available when I was starting
            out, and I want to ensure others can learn like I eventually did."
          </p>
        </div>
      </section>
      ...
      <section style={{ background: '#fff', padding: '74px 0' }}>
        ...
        >
          <div>
            ...
            >
              Fun, creative &amp; beginner friendly
            </h2>
            <p
              style={{
                fontFamily: "'Mulish'",
            ...
            >
              Perfect for kids, beginners, or anyone who loves getting creative
              with cake. Whether you're decorating your first cake or just
              looking for a creative experience, our workshops are a place to
              learn, laugh and create something delicious.
            </p>
          </div>
          <div
            style={{
      ...
      <section style={{ background: '#dcefe2', padding: '74px 0' }}>
        <div style={{ maxWidth: 620, margin: '0 auto', padding: '0 28px' }}>
          <div style={{ textAlign: 'center', marginBottom: 30 }}>
            ...
            >
              Our first workshops launch soon. Pop your details below and be the
              first to know when dates are released.
            </p>
          </div>
          ...
          {workshopSent ? (
            ...
            >
              ...
              >
                Thank you — we'll be in touch the moment workshop dates are
                released. xx
              </p>
            </div>
          ) : (
